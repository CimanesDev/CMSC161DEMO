...
export const rawTableData = {
  ...
  sales: [
    { product: 'Classic SD', revenue: 18500, unitsSold: 125, stock: 45, margin: 28 },
    { product: 'Alox Pioneer', revenue: 22100, unitsSold: 68, stock: 12, margin: 35 },
    { product: 'Champ', revenue: 28900, unitsSold: 42, stock: 8, margin: 45 },
    { product: 'Huntsman', revenue: 25600, unitsSold: 58, stock: 15, margin: 38 },
    { product: 'Minichamp', revenue: 15200, unitsSold: 95, stock: 32, margin: 32 },
    { product: 'SwissChamp', revenue: 32400, unitsSold: 28, stock: 5, margin: 48 },
    { product: 'Spartan', revenue: 19800, unitsSold: 78, stock: 22, margin: 33 },
    { product: 'Climber', revenue: 23100, unitsSold: 62, stock: 18, margin: 36 },
  ],
};
